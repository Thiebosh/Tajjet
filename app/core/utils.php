...
function somm($last7daysSleepTime) //On compte le nombre de fois où le temps de sommeil s'écarte de plus d'1h d'une nuit à l'autre, au-delà de 3 fois, on considère que le rythme n'est pas bon. 
