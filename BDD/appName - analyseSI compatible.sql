...
CREATE TABLE Categorize (ID_TVprogram INT AUTO_INCREMENT NOT NULL,
...
ALTER TABLE Include ADD CONSTRAINT FK_Use_ID_recipe FOREIGN KEY (ID_recipe) REFERENCES Recipe (ID_recipe);
ALTER TABLE Include ADD CONSTRAINT FK_Use_ID_item FOREIGN KEY (ID_item) REFERENCES Item (ID_item);
