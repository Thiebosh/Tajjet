...
CREATE TABLE Item (ID_item BIGINT AUTO_INCREMENT NOT NULL,
Label VARCHAR,
Consumable BOOLEAN,
...
CREATE TABLE Theme (ID_theme BIGINT AUTO_INCREMENT NOT NULL,
Label VARCHAR,
PRIMARY KEY (ID_theme)) ENGINE=InnoDB;

DROP TABLE IF EXISTS Use ;
CREATE TABLE Use (ID_recipe **NOT FOUND** AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Categorize (ID_TVprogram **NOT FOUND** AUTO_INCREMENT NOT NULL,
ID_Genre **NOT FOUND** NOT NULL,
...
ALTER TABLE Use ADD CONSTRAINT FK_Use_ID_recipe FOREIGN KEY (ID_recipe) REFERENCES Recipe (ID_recipe);
ALTER TABLE Use ADD CONSTRAINT FK_Use_ID_item FOREIGN KEY (ID_item) REFERENCES Item (ID_item);
...
ALTER TABLE Categorize ADD CONSTRAINT FK_Categorize_ID_TVprogram FOREIGN KEY (ID_TVprogram) REFERENCES TVprogram (ID_TVprogram);
ALTER TABLE Categorize ADD CONSTRAINT FK_Categorize_ID_Genre FOREIGN KEY (ID_Genre) REFERENCES Genre (ID_Genre);
