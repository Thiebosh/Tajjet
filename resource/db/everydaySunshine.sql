...
CREATE TABLE IF NOT EXISTS `recipe` (
  ...
  `Picture` varchar(255) CHARACTER SET latin1 COLLATE utf8_general_ci NOT NULL,
  `NbPerson` int(11) NOT NULL,
  `PreparationTime` time NOT NULL,
  `CookingTime` time NOT NULL,
  `TotalTime` time NOT NULL,
  `Score` float NOT NULL,
  `Price` varchar(255) CHARACTER SET latin1 COLLATE utf8_general_ci NOT NULL,
  `Difficulty` varchar(255) CHARACTER SET latin1 COLLATE utf8_general_ci NOT NULL,
  `Steps` text CHARACTER SET latin1 COLLATE utf8_general_ci,
  `Ingredients` text CHARACTER SET latin1 COLLATE utf8_general_ci,
